...
(172,'La Corne D'abondance, Co.','Bertrand','Mariedbo.','(1) 42.34.2555','265, boulevard Charonne',NULL,'Paris',NULL,'75012','France',1337,'84300.00'),
...
(187,'AV Stores, Co.','Ashworth','Racheldbo.','(171) 555-1555','Fauntleroy Circus',NULL,'Manchester',NULL,'EC2 5NT','UK',1501,'136800.00'),
...
(201,'UK Collectables, Ltd.','Devon','Elizabethdbo.','(171) 555-2282','12, Berkeley Gardens Blvd',NULL,'Liverpool',NULL,'WX1 6LT','UK',1501,'92700.00'),

(202,'Canadian Gift Exchange Network','Tamuri','Yoshi dbo.','(604) 555-3392','1900 Oak St.',NULL,'Vancouver','BC','V3F 2K1','Canada',1323,'90300.00'),
...
(216,'Enaco Distributors','Saavedra','Eduardo dbo.','(93) 203 4555','Rambla de Cataluña, 23',NULL,'Barcelona',NULL,'08022','Spain',1702,'60300.00'),
...
(233,'Québec Home Shopping Network','Fresnière','Jean dbo.','(514) 555-8054','43 rue St. Laurent',NULL,'Montréal','Québec','H1J 1C3','Canada',1286,'48700.00'),

(237,'ANG Resellers','Camino','Alejandra dbo.','(91) 745 6555','Gran Vía, 1',NULL,'Madrid',NULL,'28001','Spain',NULL,'0.00'),

(239,'Collectable Mini Designs Co.','Thompson','Valarie','7605558146','361 Furth Circle',NULL,'San Diego','CA','91217','USA',1166,'105000.00'),

(240,'giftsbymail.co.uk','Bennett','Helen dbo.','(198) 555-8888','Garden House','Crowther Way 23','Cowes','Isle of Wight','PO31 7PJ','UK',1501,'93900.00'),
...
(256,'Auto Associés & Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l'Europe',NULL,'Versailles',NULL,'78000','France',1370,'77900.00')dbo.,

(259,'Toms Spezialitäten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'Köln',NULL,'50739','Germany',1504,'120400.00')dbo.,

(260,'Royal Canadian Collectables, Ltd.','Lincoln','Elizabeth ','(604) 555-4555','23 Tsawassen Blvd.',NULL,'Tsawassen','BC','T2F 8M4','Canada',1323,'89600.00')dbo.,

(273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'München',NULL,'80805','Germany',NULL,'0.00'),

(276,'Anna's Decorations, Ltd','O'Hara','Anna','02 9936 8555','201 Miller Street','Level 15','North Sydney','NSW','2060','Australia',1611,'107800.00')dbo.,

(278,'Rovelli Gifts','Rovelli','Giovanni ','035-640555','Via Ludovico il Moro 22',NULL,'Bergamo',NULL,'24100','Italy',1401,'119600.00')dbo.,
...
(314,'Petit Auto','Dewey','Catherine dbo.','(02) 5554 67','Rue Joseph-Bens 532',NULL,'Bruxelles',NULL,'B-1180','Belgium',1401,'79900.00'),
...
(324,'Stylish Desk Decors, Co.','Brown','Ann dbo.','(171) 555-0297','35 King George',NULL,'London',NULL,'WX3 6FW','UK',1501,'77000.00'),
...
(347,'Men 'R' US Retailers, Ltd.','Chandler','Brian','2155554369','6047 Douglas Av.',NULL,'Los Angeles','CA','91003','USA',1166,'57700.00')dbo.,

(348,'Asian Treasures, Inc.','McKenna','Patricia ','2967 555','8 Johnstown Road',NULL,'Cork','Co. Cork',NULL,'Ireland',NULL,'0.00')dbo.,
...
(369,'Lisboa Souveniers, Inc','Rodriguez','Lino dbo.','(1) 354-2555','Jardim das rosas n. 32',NULL,'Lisboa',NULL,'1675','Portugal',NULL,'0.00'),
...
(381,'Royale Belge','Cartrain','Pascale dbo.','(071) 23 67 2555','Boulevard Tirou, 255',NULL,'Charleroi',NULL,'B-6000','Belgium',1401,'23500.00'),
...
(406,'Auto Canal+ Petit','Perrier','Dominiquedbo.','(1) 47.55.6555','25, rue Lauriston',NULL,'Paris',NULL,'75016','France',1337,'95000.00'),
...
(458,'Corrida Auto Replicas, Ltd','Sommer','Martín dbo.','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,'104600.00'),
...
(484,'Iberia Gift Imports, Corp.','Roel','José Pedro dbo.','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','Spain',1702,'65700.00'),
...
(489,'Double Decker Gift Stores, Ltd','Smith','Thomas dbo.','(171) 555-7555','120 Hanover Sq.',NULL,'London',NULL,'WA1 1DP','UK',1501,'43300.00'),
...
/* SQLINES DEMO *** r table `orderdetails` */
...
(10165,'2003-10-22','2003-10-31','2003-12-26','Shipped','This order was on hold because customers's credit limit had been exceeded. Order will ship when payment is received',148)dbo.,
...
(10327,'2004-11-10','2004-11-19','2004-11-13','Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don't match what was discussed.',145)dbo.,

(10328,'2004-11-12','2004-11-21','2004-11-18','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',278)dbo.,

(10329,'2004-11-15','2004-11-24','2004-11-16','Shipped',NULL,131)dbo.,

(10330,'2004-11-16','2004-11-25','2004-11-21','Shipped',NULL,385)dbo.,

(10331,'2004-11-17','2004-11-23','2004-11-23','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',486)dbo.,

(10332,'2004-11-17','2004-11-25','2004-11-18','Shipped',NULL,187)dbo.,

(10333,'2004-11-18','2004-11-27','2004-11-20','Shipped',NULL,129)dbo.,

(10334,'2004-11-19','2004-11-28',NULL,'On Hold','The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.',144)dbo.,

(10335,'2004-11-19','2004-11-29','2004-11-23','Shipped',NULL,124)dbo.,

(10336,'2004-11-20','2004-11-26','2004-11-24','Shipped','Customer requested that DHL is used for this shipping',172)dbo.,

(10337,'2004-11-21','2004-11-30','2004-11-26','Shipped',NULL,424)dbo.,

(10338,'2004-11-22','2004-12-02','2004-11-27','Shipped',NULL,381)dbo.,

(10339,'2004-11-23','2004-11-30','2004-11-30','Shipped',NULL,398)dbo.,

(10340,'2004-11-24','2004-12-01','2004-11-25','Shipped','Customer is interested in buying more Ferrari models',216)dbo.,

(10341,'2004-11-24','2004-12-01','2004-11-29','Shipped',NULL,382)dbo.,

(10342,'2004-11-24','2004-12-01','2004-11-29','Shipped',NULL,114)dbo.,

(10343,'2004-11-24','2004-12-01','2004-11-26','Shipped',NULL,353)dbo.,

(10344,'2004-11-25','2004-12-02','2004-11-29','Shipped',NULL,350)dbo.,

(10345,'2004-11-25','2004-12-01','2004-11-26','Shipped',NULL,103)dbo.,

(10346,'2004-11-29','2004-12-05','2004-11-30','Shipped',NULL,112)dbo.,

(10347,'2004-11-29','2004-12-07','2004-11-30','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',114)dbo.,

(10348,'2004-11-01','2004-11-08','2004-11-05','Shipped',NULL,458)dbo.,

(10349,'2004-12-01','2004-12-07','2004-12-03','Shipped',NULL,151)dbo.,

(10350,'2004-12-02','2004-12-08','2004-12-05','Shipped',NULL,141)dbo.,

(10351,'2004-12-03','2004-12-11','2004-12-07','Shipped',NULL,324)dbo.,

(10352,'2004-12-03','2004-12-12','2004-12-09','Shipped',NULL,198)dbo.,

(10353,'2004-12-04','2004-12-11','2004-12-05','Shipped',NULL,447)dbo.,

(10354,'2004-12-04','2004-12-10','2004-12-05','Shipped',NULL,323)dbo.,

(10355,'2004-12-07','2004-12-14','2004-12-13','Shipped',NULL,141)dbo.,

(10356,'2004-12-09','2004-12-15','2004-12-12','Shipped',NULL,250)dbo.,

(10357,'2004-12-10','2004-12-16','2004-12-14','Shipped',NULL,124)dbo.,

(10358,'2004-12-10','2004-12-16','2004-12-16','Shipped','Customer requested that DHL is used for this shipping',141)dbo.,

(10359,'2004-12-15','2004-12-23','2004-12-18','Shipped',NULL,353)dbo.,

(10360,'2004-12-16','2004-12-22','2004-12-18','Shipped',NULL,496)dbo.,

(10361,'2004-12-17','2004-12-24','2004-12-20','Shipped',NULL,282)dbo.,

(10362,'2005-01-05','2005-01-16','2005-01-10','Shipped',NULL,161)dbo.,

(10363,'2005-01-06','2005-01-12','2005-01-10','Shipped',NULL,334)dbo.,

(10364,'2005-01-06','2005-01-17','2005-01-09','Shipped',NULL,350)dbo.,

(10365,'2005-01-07','2005-01-18','2005-01-11','Shipped',NULL,320)dbo.,
...
(10386,'2005-03-01','2005-03-09','2005-03-06','Resolved','Disputed then Resolved on 3/15/2005. Customer doesn't like the craftsmaship of the models.',141)dbo.,

(10387,'2005-03-02','2005-03-09','2005-03-06','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',148)dbo.,

(10388,'2005-03-03','2005-03-11','2005-03-09','Shipped',NULL,462)dbo.,

(10389,'2005-03-03','2005-03-09','2005-03-08','Shipped',NULL,448)dbo.,

(10390,'2005-03-04','2005-03-11','2005-03-07','Shipped','They want to reevaluate their terms agreement with Finance.',124)dbo.,

(10391,'2005-03-09','2005-03-20','2005-03-15','Shipped',NULL,276)dbo.,

(10392,'2005-03-10','2005-03-18','2005-03-12','Shipped',NULL,452)dbo.,

(10393,'2005-03-11','2005-03-22','2005-03-14','Shipped','They want to reevaluate their terms agreement with Finance.',323)dbo.,

(10394,'2005-03-15','2005-03-25','2005-03-19','Shipped',NULL,141)dbo.,

(10395,'2005-03-17','2005-03-24','2005-03-23','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',250)dbo.,

(10396,'2005-03-23','2005-04-02','2005-03-28','Shipped',NULL,124)dbo.,

(10397,'2005-03-28','2005-04-09','2005-04-01','Shipped',NULL,242)dbo.,

(10398,'2005-03-30','2005-04-09','2005-03-31','Shipped',NULL,353)dbo.,

(10399,'2005-04-01','2005-04-12','2005-04-03','Shipped',NULL,496)dbo.,

(10400,'2005-04-01','2005-04-11','2005-04-04','Shipped','Customer requested that DHL is used for this shipping',450)dbo.,

(10401,'2005-04-03','2005-04-14',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',328)dbo.,

(10402,'2005-04-07','2005-04-14','2005-04-12','Shipped',NULL,406)dbo.,

(10403,'2005-04-08','2005-04-18','2005-04-11','Shipped',NULL,201)dbo.,

(10404,'2005-04-08','2005-04-14','2005-04-11','Shipped',NULL,323)dbo.,

(10405,'2005-04-14','2005-04-24','2005-04-20','Shipped',NULL,209)dbo.,

(10406,'2005-04-15','2005-04-25','2005-04-21','Disputed','Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.',145)dbo.,

(10407,'2005-04-22','2005-05-04',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',450)dbo.,

(10408,'2005-04-22','2005-04-29','2005-04-27','Shipped',NULL,398)dbo.,

(10409,'2005-04-23','2005-05-05','2005-04-24','Shipped',NULL,166)dbo.,

(10410,'2005-04-29','2005-05-10','2005-04-30','Shipped',NULL,357)dbo.,

(10411,'2005-05-01','2005-05-08','2005-05-06','Shipped',NULL,233)dbo.,

(10412,'2005-05-03','2005-05-13','2005-05-05','Shipped',NULL,141)dbo.,

(10413,'2005-05-05','2005-05-14','2005-05-09','Shipped','Customer requested that DHL is used for this shipping',175)dbo.,
...
(10417,'2005-05-13','2005-05-19','2005-05-19','Disputed','Customer doesn't like the colors and precision of the models.',141)dbo.,

(10418,'2005-05-16','2005-05-24','2005-05-20','Shipped',NULL,412)dbo.,

(10419,'2005-05-17','2005-05-28','2005-05-19','Shipped',NULL,382)dbo.,

(10420,'2005-05-29','2005-06-07',NULL,'In Process',NULL,282)dbo.,

(10421,'2005-05-29','2005-06-06',NULL,'In Process','Custom shipping instructions were sent to warehouse',124)dbo.,

(10422,'2005-05-30','2005-06-11',NULL,'In Process',NULL,157)dbo.,

(10423,'2005-05-30','2005-06-05',NULL,'In Process',NULL,314)dbo.,

(10424,'2005-05-31','2005-06-08',NULL,'In Process',NULL,141)dbo.,

(10425,'2005-05-31','2005-06-07',NULL,'In Process',NULL,119);

/* SQLINES DEMO *** r table `payments` */
...
/* SQLINES DEMO *** r table `productlines` */
...
('S18_4668','1939 Cadillac Limousine','Vintage Cars','1:18','Studio M Art Models','Features completely detailed interior including Velvet flocked drapes,deluxe wood grain floor, and a wood grain casket with seperate chrome handles',6645,'23.14','50.31')dbo.,

('S18_4721','1957 Corvette Convertible','Classic Cars','1:18','Classic Metal Creations','1957 die cast Corvette Convertible in Roman Red with white sides and whitewall tires. 1:18 scale quality die-cast with detailed engine and underbvody. Now you can own The Classic Corvette.',1249,'69.93','148.80')dbo.,

('S18_4933','1957 Ford Thunderbird','Classic Cars','1:18','Studio M Art Models','This 1:18 scale precision die-cast replica, with its optional porthole hardtop and factory baked-enamel Thunderbird Bronze finish, is a 100% accurate rendition of this American classic.',3209,'34.21','71.27')dbo.,

('S24_1046','1970 Chevy Chevelle SS 454','Classic Cars','1:24','Unimax Art Galleries','This model features rotating wheels, working streering system and opening doors. All parts are particularly delicate due to their precise scale and require special care and attention. It should not be picked up by the doors, roof, hood or trunk.',1005,'49.24','73.49')dbo.,

('S24_1444','1970 Dodge Coronet','Classic Cars','1:24','Highway 66 Mini Classics','1:24 scale die-cast about 18" long doors open, hood opens and rubber wheels',4074,'32.37','57.80')dbo.,
...
('S32_4289','1928 Ford Phaeton Deluxe','Vintage Cars','1:32','Highway 66 Mini Classics','This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system',136,'33.02','68.79')dbo.,

('S32_4485','1974 Ducati 350 Mk3 Desmo','Motorcycles','1:32','Second Gear Diecast','This model features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand',3341,'56.13','102.05')dbo.,

('S50_1341','1930 Buick Marquette Phaeton','Vintage Cars','1:50','Studio M Art Models','Features opening trunk,  working steering system',7062,'27.06','43.64')dbo.,

('S50_1392','Diamond T620 Semi-Skirted Tanker','Trucks and Buses','1:50','Highway 66 Mini Classics','This limited edition model is licensed and perfectly scaled for Lionel Trains. The Diamond T620 has been produced in solid precision diecast and painted with a fire baked enamel finish. It comes with a removable tanker and is a perfect model to add authenticity to your static train or car layout or to just have on display.',1016,'68.29','115.75')dbo.,

('S50_1514','1962 City of Detroit Streetcar','Trains','1:50','Classic Metal Creations','This streetcar is a joy to see. It has 99 separate windows, electric wire guides, detailed interiors with seats, poles and drivers controls, rolling and turning wheel assemblies, plus authentic factory baked-enamel finishes (Green Hornet for Chicago and Cream and Crimson for Boston).',1645,'37.49','58.58')dbo.,

('S50_4713','2002 Yamaha YZR M1','Motorcycles','1:50','Autoart Studio Design','Features rotating wheels , working kick stand. Comes with stand.',600,'34.17','81.36')dbo.,

('S700_1138','The Schooner Bluenose','Ships','1:700','Autoart Studio Design','All wood with canvas sails. Measures 31 1/2 inches in Length, 22 inches High and 4 3/4 inches Wide. Many extras.rnThe schooner Bluenose was built in Nova Scotia in 1921 to fish the rough waters off the coast of Newfoundland. Because of the Bluenose racing prowess she became the pride of all Canadians. Still featured on stamps and the Canadian dime, the Bluenose was lost off Haiti in 1946.',1897,'34.00','66.67')dbo.,

('S700_1691','American Airlines: B767-300','Planes','1:700','Min Lin Diecast','Exact replia with official logos and insignias and retractable wheels',5841,'51.15','91.34')dbo.,

('S700_1938','The Mayflower','Ships','1:700','Studio M Art Models','Measures 31 1/2 inches Long x 25 1/2 inches High x 10 5/8 inches WidernAll wood with canvas sail. Extras include long boats, rigging, ladders, railing, anchors, side cannons, hand painted, etc.',737,'43.30','86.61')dbo.,

('S700_2047','HMS Bounty','Ships','1:700','Unimax Art Galleries','Measures 30 inches Long x 27 1/2 inches High x 4 3/4 inches Wide. rnMany extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.',3501,'39.83','90.52')dbo.,

('S700_2466','America West Airlines B757-200','Planes','1:700','Motor City Art Classics','Official logos and insignias. Working steering system. Rotating jet engines',9653,'68.80','99.72')dbo.,

('S700_2610','The USS Constitution Ship','Ships','1:700','Red Start Diecast','All wood with canvas sails. Measures 31 1/2" Length x 22 3/8" High x 8 1/4" Width. Extras include 4 boats on deck, sea sprite on bow, anchors, copper railing, pilot houses, etc.',7083,'33.97','72.28')dbo.,

('S700_2824','1982 Camaro Z28','Classic Cars','1:18','Carousel DieCast Legends','Features include opening and closing doors. Color: White. rnMeasures approximately 9 1/2" Long.',6934,'46.53','101.15')dbo.,

('S700_2834','ATA: B757-300','Planes','1:700','Highway 66 Mini Classics','Exact replia with official logos and insignias and retractable wheels',7106,'59.33','118.65')dbo.,

('S700_3167','F/A 18 Hornet 1/72','Planes','1:72','Motor City Art Classics','10" Wingspan with retractable landing gears.Comes with pilot',551,'54.40','80.00')dbo.,

('S700_3505','The Titanic','Ships','1:700','Carousel DieCast Legends','Completed model measures 19 1/2 inches long, 9 inches high, 3inches wide and is in barn red/black. All wood and metal.',1956,'51.09','100.17')dbo.,

('S700_3962','The Queen Mary','Ships','1:700','Welly Diecast Productions','Exact replica. Wood and Metal. Many extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.',5088,'53.63','99.31')dbo.,

('S700_4002','American Airlines: MD-11S','Planes','1:700','Second Gear Diecast','Polished finish. Exact replia with official logos and insignias and retractable wheels',8820,'36.27','74.03')dbo.,

('S72_1253','Boeing X-32A JSF','Planes','1:72','Motor City Art Classics','10" Wingspan with retractable landing gears.Comes with pilot',4857,'32.77','49.66')dbo.,
